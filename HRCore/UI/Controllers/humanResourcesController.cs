...
namespace UI.Controllers
{
    public class humanResourcesController : Controller
    {
        ...
        public humanResourcesController(IEngage_resumeBLL1 Resume,IHuman_fileBLL1 Files,IConfig_public_charBLL1 Char,IUsersBLL1 user,IConfig_majorBLL1 Major,IConfig_major_kindBLL1 Makind,IConfig_file_first_kindBLL1 First, IConfig_file_second_kindBLL1 Second, IConfig_file_third_kindBLL1 Third, IWebHostEnvironment environment)
        {
            this.Makind = Makind;
            this.Major = Major;
            this.First = First;
